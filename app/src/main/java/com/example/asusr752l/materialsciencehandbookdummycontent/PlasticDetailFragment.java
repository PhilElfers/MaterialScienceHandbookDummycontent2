package com.example.asusr752l.materialsciencehandbookdummycontent;
...
import com.example.asusr752l.materialsciencehandbookdummycontent.dummy.DummyContent;
...
public class PlasticDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.plastic_detail)).setText(mItem.details);
        }
